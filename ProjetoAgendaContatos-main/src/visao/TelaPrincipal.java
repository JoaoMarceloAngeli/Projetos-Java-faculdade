...
private void abrirPdf() {
    ...
    private void jButton1_AdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1_AdicionarActionPerformed
        ...
        try{
            ...
            String erro = "";
            if(jTextField1_NomeCompleto.getText().isEmpty()) erro += "Esse campo (Nome) e obrigatorio, nao pode estar vazio.\n";
            if(jTextField1_NomeCompleto.getText().isEmpty()) erro += "Esse campo (Nome) e obrigatorio, nao pode estar vazio.\n";
            ...
            if(jTextField1_Email.getText().isEmpty()) erro += "Esse campo (Email) e obrigatorio, nao pode estar vazio\n.";
            ...
            if(jFormattedTextField1_CEP.getText().isEmpty()) erro += "Esse campo (CEP) nao pode estar vazio.\n";
            if(!jFormattedTextField1_CEP.getText().matches("[0-9]+")) erro += "Esse campo (CEP) somente aceita numeros.\n";    
            if(jTextField4_Cidade.getText().isEmpty()) erro += "Esse campo (Cidade) e obrigatorio, nao pode estar vazio.\n";
            if(jTextField4_UF.getText().isEmpty()) erro += "Esse campo (Estado) e obrigatorio, nao pode estar vazio.\n";
