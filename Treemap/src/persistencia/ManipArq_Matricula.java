...
public class ManipArq_Matricula{
    ...
    public Map<Integer,Professor> obterProfess_Matricula() throws Exception{
        try{
        TreeMap<Integer,Professor> professores = new TreeMap<>();
        ...
        professores.put(conjtProfessor.getMatricula(), conjtProfessor);
        }
        bufLer.close();
        return professores;
        }
